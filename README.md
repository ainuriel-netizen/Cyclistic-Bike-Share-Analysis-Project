...
cyclistic-analysis/
├── RU/                              # 🇷🇺 RUSSIAN VERSION
│   ├── Report Ru.md                 # Full analysis (Russian only)
│   ├── README Ru.md                 # Project documentation (Russian)
│   └── Cyclistic Rus.pdf            # Interactive dashboard
│
├── EN/                              # 🇬🇧 ENGLISH VERSION
│   ├── Report En.md                 # Full analysis (English only)
│   ├── README En.md                 # Project documentation (English)
│   └── Cyclistic En.pdf             # Interactive dashboard
│
└── INDEX.md                         # This file
